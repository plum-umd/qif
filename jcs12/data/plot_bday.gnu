...
'data_bday_q0.tsv' using 4:17 axes x1y1 title 'prob-poly-set' with points ls 2
...
'data_bday_large_q0.tsv' using 4:17  axes x1y1 title 'prob-poly-set' with points ls 2
...
plot \
'data_bday_q2.tsv' using 4:17:1 with labels left offset 0,0 font "Helvetica,14"
