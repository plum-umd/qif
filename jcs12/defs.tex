%%% longtabloe hline that works with \nopagebreak
...
\newcommand{\intdomain}{\mathbb{C_I}}
\newcommand{\octadomain}{\mathbb{C_O}}

\newcommand{\pintdomain}{\mathbb{I}}
\newcommand{\poctadomain}{\mathbb{O}}
\newcommand{\ppintdomain}{\powersetb{n}{\mathbb{I}}}
\newcommand{\ppoctadomain}{\powersetb{n}{\mathbb{O}}}

\newcommand{\iconc}[1]{\gamma_{\intdomain}(#1)}
\newcommand{\oconc}[1]{\gamma_{\octadomain}(#1)}

\newcommand{\piconc}[1]{\gamma_{\pintdomain}(#1)}
\newcommand{\poconc}[1]{\gamma_{\poctadomain}(#1)}
...
\newcommand{\areturn}[0]{\text{\textbf{return} }}
\newcommand{\awhile}[0]{\text{\textbf{while} }}
...
\newcommand{\lbinop}[3]{#2\;#1\;#3}
\newcommand{\lreln}[3]{#2#1#3}
...
\newcommand{\psdefine}[2]{\mathsf{\#define}\;{#1}\;=\;{#2}}
\newcommand{\psinclude}[1]{\mathsf{\#include}\;{#1}}

\def\ismodeledby{=\joinrel\mathrel|}
\newcommand{\ddnf}[1]{\text{ddnf}\paren{#1}}
...
\newcommand{\partop}{\searrow\!\!\!\!\!\!\!\swarrow}
\newcommand{\partn}[2]{{#1}\partop{#2}}
...
\newcommand{\absdcond}[2]{#1 \wedge #2}
\newcommand{\absdrevise}[2]{#1 | #2}
